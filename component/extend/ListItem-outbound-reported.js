  ...
  return (
    <ThemeProvider theme={theme}>
      <ListItem
        ...
        activeScale={0.95}>
        <View style={[styles.leftList,{backgroundColor:'red'}]}>
        </View>
        ...
        <Badge value="Reported" status="warning" textStyle={{...Mixins.small3,fontWeight: '400',lineHeight: 15}} containerStyle={{flexShrink:1, paddingVertical:10}} />
         <ListItem.Chevron
