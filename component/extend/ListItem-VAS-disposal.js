  ...
  return (
    <ThemeProvider theme={theme}>
      <ListItem
        ...
        <View style={[styles.detailContainer,{flexDirection:'row', flexGrow: 1, paddingRight:PixelRatio.get() > 2.75 ? 50 : 40}]}>          
          <View style={{flexDirection: 'column', flex: 1,}}>
          
            <View style={{flexDirection: 'row',flex:1, marginRight:PixelRatio.get() > 2.75 ? 80 : 70}}>
