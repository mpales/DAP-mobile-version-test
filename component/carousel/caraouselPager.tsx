...
export default class CarouselPager extends Component {
  ...
  constructor(props: Props) {
    super(props);
    (this as any).scrollToPage = this.scrollToPage.bind(this);
    (this as any)._pageStateChange = this._pageStateChange.bind(this);
    (this as any)._selectedPage = this._selectedPage.bind(this);
    (this as any)._pageScroll = this._pageScroll.bind(this);
    this.state = {
      pageState: 'idle',
    };
  }
