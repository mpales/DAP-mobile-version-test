...
export default class Carousel extends Component {
  ...
  constructor(props: Props) {
    ...
    (this as any).getWidth = this.getWidth.bind(this);
    (this as any).indicatorPressed = this.indicatorPressed.bind(this);
    (this as any).renderPageIndicator = this.renderPageIndicator.bind(this);
    (this as any)._setUpTimer = this._setUpTimer.bind(this);
    (this as any)._animateNextPage = this._animateNextPage.bind(this);
    (this as any)._onAnimationBegin = this._onAnimationBegin.bind(this);
    (this as any)._onAnimationEnd = this._onAnimationEnd.bind(this);
    (this as any)._filterChildren = this._filterChildren.bind(this);
    (this as any)._resetPager = this._resetPager.bind(this);
    (this as any).children = Children.toArray(props.children).filter(
      (child) => child,
    );
  }
