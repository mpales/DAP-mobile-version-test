    ...
    render() {
        return(
            <SafeAreaProvider>
                ...
                >
                            <Text style={{...Mixins.subtitle1,lineHeight: 21,color:'#424141', paddingHorizontal: 20, marginTop: 15}}>SKU 00992233441 </Text>
                    ...
                    <Button
                                ...
                                buttonStyle={[styles.navigationButton, {backgroundColor: '#fff',borderWidth: 1, borderColor: '#6C6B6B',paddingHorizontal: 0}]}
