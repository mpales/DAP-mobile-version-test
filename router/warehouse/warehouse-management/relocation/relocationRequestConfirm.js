...
class RelocationRequestConfirm extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      gradeList: GRADELIST,
      warehouseStorageContainerIdTo:
        this.props.route.params?.warehouseStorageContainerIdTo ?? null,
  ...
  confirmRelocate = async () => {
    ...
    const data = {
      ...
      warehouseStorageContainerIdTo: warehouseStorageContainerIdTo,
  ...
  buttonDisabled = () => {
    ...
    if (
      selectedGrade === null ||
      selectedReasonCode === null ||
      warehouseStorageContainerIdTo === null ||
      isSubmitting
    ) {
      return true;
    } else if (
