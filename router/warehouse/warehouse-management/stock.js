...
//component
import Stock from '../../../component/extend/ListItem-stock';
//style
...
class ListStock extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            search: '',
...
export default connect(mapStateToProps, mapDispatchToProps)(ListStock)