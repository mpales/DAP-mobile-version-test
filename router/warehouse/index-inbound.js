      ...
      ()=>{
         ...
         if (this.props.keyStack === 'List' && this.props.indexBottomBar === 0) {
          ...
          return true;
            ...
            this.navigationRef.current.navigate('Inbound', {screen: 'List'})
            return true;
            } else if(prevProps.keyStack === 'Manifest' && this.props.keyStack === 'Barcode' && this.props.indexBottomBar === 0){
            ...
            this.navigationRef.current.navigate('Inbound', {screen: 'Manifest'})
            return true;    
          } else if(this.props.keyStack === 'containerDetail' && this.props.indexBottomBar === 0){
            this.navigationRef.current.navigate('Inbound', {screen: 'Manifest'})
            return true;    
          }  else if(this.props.keyStack === 'newItem' && this.props.indexBottomBar === 0){
            this.navigationRef.current.navigate('Inbound', {screen: 'Manifest'})
            return true;    
