...
class EnlargeImage extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState){
        if(this.state.pictureData === null){
            this.props.navigation.navigate('POSMSingleCamera');
    ...
    componentDidMount() {
        ...
        if(routes[index].params !== undefined && routes[index].params.index !== undefined) {
            this.setState({
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        addPhotoProofPostpone: (uri) => dispatch({type: 'POSMPostpone', payload: uri}),
        addPhotoProofUpdate: (data) => dispatch({type: 'POSMUpdate', payload: data}),
    };
};
