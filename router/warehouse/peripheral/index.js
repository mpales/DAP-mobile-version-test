      ...
      if (
        ...
        manifestList.some(
          (element) =>
            ...
            element.barcodes.some(
              (element) =>
                routes[index].params.manualCode === element.code_number,
            ) === true,
        )
      ) {
        setBarcodeScanner(false);
        ...
        return {
          ...state,
          scanItem: elementItem.pId,
          dataCode: routes[index].params.manualCode,
        };
      } else if (
        dataCode !== '0' &&
        dataCode !== 'transit' &&
        manifestList.some(
          (element) =>
            element.barcodes !== undefined &&
            element.barcodes.some(
              (element) => dataCode === element.code_number,
            ) === true,
        )
      ) {
        setBarcodeScanner(false);
        ...
        dataCode === 'transit' &&
        manifestList.some((o) => o.is_transit === 1)
      ) {
        setBarcodeScanner(false);
        let elementItem = manifestList.find(
          (element) => element.is_transit === 1,
        );
        return {...state, scanItem: elementItem.pId};
      }
      return {...state};
  ...
  renderModal = (props) => {
    ...
    return (
      <ScrollView
        ...
        scrollEnabled={
          dataItem === null && this.state.multipleSKU === true ? false : true
        }
        horizontal={
          dataItem === null && this.state.multipleSKU === true ? true : false
        }
        ...
        <Animated.View
          style={
            ...
            (dataItem === null && this.state.multipleSKU === true)
              ? [
                  dataItem !== null && dataItem.is_transit !== 1
                    ? styles.modalContainerAll
                    : styles.modalContainerAllTransit,
                  {
                    transform: [
                      {
              ...
              ? [
                  dataItem !== null && dataItem.is_transit !== 1
                    ...
                    : styles.modalContainerSmallConfirmTransit,
                  {
                    transform: [
                      {
                        scaleX: this.animatedValue.interpolate({
            ...
            ((this.state.enterAttr === false && this.state.isPOSM === false) ||
                              ...
                              <View
                                style={{
                                  ...
                                  backgroundColor:
                                    ...
                                    findPallet.palete_id ===
                                      this.state.ItemPallet
                                      ? '#e7e8f2'
                                      : 'transparent',
                                  paddingVertical: 0,
                                  marginVertical: 0,
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Input
                        containerStyle={
                          dataItem.is_transit !== 1
                            ? {flex: 1, paddingVertical: 0, height: 40}
              ...
              <View
                style={[
                  styles.sheetPackages,
                  {
                    marginHorizontal: 0,
                    marginTop: 20,
                    maxHeight: (screen.height * 35) / 100,
                  },
                ]}>
                <FlatList
              ...
              <View
                style={[
                  ...
                  {
                    marginHorizontal: 32,
                    marginTop: this.state.keyboardState === 'hide' ? 20 : 60,
                  },
                ]}>
                <View
                  style={[styles.sectionDividier, {alignItems: 'flex-start'}]}>
                  ...
                  {this.state.dataItem.specialField.expiryDateTracking ===
                    1 && (
                    <TemplateDate
                      required={
      ...
      <View style={styles.container}>
        ...
        <TouchableWithoutFeedback onPress={() => {}}>
          <BarCode
            ...
            useManualMenu={true}
            barcodeContext={'Scan Item Barcode Here'}
          />
        </TouchableWithoutFeedback>
      </View>
    );
