    ...
    return (
      ...
      <ScrollView style={{flex: 1, backgroundColor: 'white', paddingHorizontal: 20, paddingVertical: 20}}>
        ...
        <View style={{flexDirection: 'row',flex:1}}>
          ...
          <View style={{flexDirection: 'row',flex:1}}>
            <View style={{width:100}}>
            <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600'}}>Barcode</Text>
          </View>
          <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600',textAlign: 'right',flexShrink: 1}}>:</Text>
          <Text style={{...Mixins.small3, lineHeight: 15, color: '#6C6B6B', fontWeight: '400'}}>
          EBV 2BL - TL
          ...
          <View style={{flexDirection: 'row',flex:1}}>
            <View style={{width:100}}>
            <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600'}}>Description</Text>
          </View>
          <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600',textAlign: 'right',flexShrink: 1}}>:</Text>
          <Text style={{...Mixins.small3, lineHeight: 15, color: '#6C6B6B', fontWeight: '400'}}>
          ...
          <View style={{flexDirection: 'row',flex:1}}>
            <View style={{width:100}}>
            <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600'}}>Category</Text>
          </View>
          <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600',textAlign: 'right',flexShrink: 1}}>:</Text>
          <Text style={{...Mixins.small3, lineHeight: 15, color: '#6C6B6B', fontWeight: '400'}}>
          -
          ...
          <View style={{flexDirection: 'row',flex:1}}>
            <View style={{width:100}}>
            <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600'}}>Pick By</Text>
          </View>
          <Text style={{...Mixins.subtitle3,lineHeight: 21,color: '#000000', fontWeight: '600',textAlign: 'right',flexShrink: 1}}>:</Text>
          <Text style={{...Mixins.small3, lineHeight: 15, color: '#6C6B6B', fontWeight: '400'}}>
          Adam
