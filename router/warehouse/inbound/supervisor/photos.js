  ...
  static getDerivedStateFromProps(props,state){
   ...
   shouldComponentUpdate(nextProps, nextState) {
    if(this.props.keyStack !== nextProps.keyStack){
      if(nextProps.keyStack === 'PhotosDraftSPV' && this.props.keyStack ==='CameraMulti'){
  ...
  async componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if(this.state.updateData === true){
      ...
      if(typeof result === 'object' && result.error === undefined){
        ...
        if(this.props.keyStack === 'PhotosDraftSPV')
    ...
    return (
      <ScrollView style={[StyleSheet.absoluteFill,{backgroundColor:'white',paddingHorizontal:40,paddingVertical:0}]}>
       <Card containerStyle={{marginVertical:20, marginHorizontal:0}}>
            <Card.Title style={{textAlign:'left',...Mixins.subtitle3,color:'#424141',fontWeight:'600',lineHeight:21}}>Photo Before Opening Container</Card.Title>
        ...
        <Button
            ...
            <Card containerStyle={{marginVertical:20,marginHorizontal:0}}>
            <Card.Title style={{textAlign:'left',...Mixins.subtitle3,color:'#424141',fontWeight:'600',lineHeight:21}}>Photo After Opening Container</Card.Title>
            <FlatList
            horizontal={true}
            keyExtractor={(item,index)=>index}
