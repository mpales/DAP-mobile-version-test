...
class Acknowledge extends React.Component {
  ...
  async componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (
      (prevState.barcode !== this.state.barcode && this.state.barcode !== '') ||
      (prevState.recordPhoto !== this.state.recordPhoto &&
        this.state.recordPhoto === true) ||
      (prevState.validDimensions !== this.state.validDimensions &&
